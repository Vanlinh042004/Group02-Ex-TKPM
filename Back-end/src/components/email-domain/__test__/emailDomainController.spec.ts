...
// Helper function cho mock request và response
...
describe('EmailDomainController', () => {
  ...
  describe('addAllowedEmailDomain', () => {
    it('should add a domain successfully', async () => {
      ...
      (EmailDomainService.addAllowedEmailDomain as jest.Mock).mockResolvedValue(mockDomain);
      ...
      expect(EmailDomainService.addAllowedEmailDomain).toHaveBeenCalledWith('example.com');
    ...
    it('should handle errors when adding a domain', async () => {
      ...
      (EmailDomainService.addAllowedEmailDomain as jest.Mock).mockRejectedValue(mockError);
  ...
  describe('deleteAllowedEmailDomain', () => {
    it('should delete a domain successfully', async () => {
      const mockDomain = { domain: 'example.com', _id: 'some-id' };
      (EmailDomainService.deleteAllowedEmailDomain as jest.Mock).mockResolvedValue(mockDomain);
      ...
      expect(EmailDomainService.deleteAllowedEmailDomain).toHaveBeenCalledWith('example.com');
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({
    ...
    it('should handle errors when deleting a domain', async () => {
      ...
      (EmailDomainService.deleteAllowedEmailDomain as jest.Mock).mockRejectedValue(mockError);
  ...
  describe('updateAllowedEmailDomain', () => {
    it('should update a domain successfully', async () => {
      ...
      (EmailDomainService.updateAllowedEmailDomain as jest.Mock).mockResolvedValue(mockDomain);
      ...
      expect(EmailDomainService.updateAllowedEmailDomain).toHaveBeenCalledWith('example.com', 'new-example.com');
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({
    ...
    it('should handle errors when updating a domain', async () => {
      const mockError = new Error('Domain not found');
      (EmailDomainService.updateAllowedEmailDomain as jest.Mock).mockRejectedValue(mockError);
  ...
  describe('getAllAllowedEmailDomains', () => {
    it('should get all domains successfully', async () => {
      ...
      (EmailDomainService.getAllAllowedEmailDomains as jest.Mock).mockResolvedValue(mockDomains);
    ...
    it('should handle errors when getting all domains', async () => {
      ...
      (EmailDomainService.getAllAllowedEmailDomains as jest.Mock).mockRejectedValue(mockError);
