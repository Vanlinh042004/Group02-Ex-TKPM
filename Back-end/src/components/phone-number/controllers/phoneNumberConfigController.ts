...
class PhoneNumberConfigController {
    ...
    async addPhoneNumberConfig(req: Request, res: Response) {
        try {
            ...
            const newPhoneNumberConfig = await phoneNumberService.addPhoneNumberConfig(phoneNumberConfig);
    ...
    async updatePhoneNumberConfig(req: Request, res: Response) {
        try {
            const country = req.params.country;
            const phoneNumberConfig = req.body;
            const updatedPhoneNumberConfig = await phoneNumberService.updatePhoneNumberConfig(country, phoneNumberConfig);
