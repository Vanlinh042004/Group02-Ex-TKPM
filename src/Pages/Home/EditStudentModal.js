...
if (!emailRegex.test(updatedStudent.email)) {
  ...
  if (!phoneRegex.test(updatedStudent.phone)) {
    ...
    axios
      .patch(`http://localhost:3000/api/student/update/${studentData.studentId}`, studentData)
      .then((response) => {
      ...
      .catch((error) => {
        ...
        message.error(error.response?.data?.message || "Cập nhật sinh viên thất bại.");
      });
  };
      ...
      <Form layout="vertical">
        ...
        <Form.Item label="Giới tính">
          <Select
            ...
            onChange={(value) => setUpdatedStudent({ ...updatedStudent, gender: value })}
          >
        ...
        <Form.Item label="Khoa">
          <Select
            ...
            onChange={(value) => setUpdatedStudent({ ...updatedStudent, faculty: value })}
          >
            <Select.Option value="Khoa Luật">Khoa Luật</Select.Option>
            <Select.Option value="Khoa Tiếng Anh thương mại">Khoa Tiếng Anh thương mại</Select.Option>
            <Select.Option value="Khoa Tiếng Nhật">Khoa Tiếng Nhật</Select.Option>
            <Select.Option value="Khoa Tiếng Pháp">Khoa Tiếng Pháp</Select.Option>
          </Select>
        </Form.Item>
        ...
        <Form.Item label="Trạng thái">
          <Select
            ...
            onChange={(value) => setUpdatedStudent({ ...updatedStudent, status: value })}
          >
